 ...
 * @returns {Promise<any>}
 */
export function getGoodsStockList(ids, loading = true) {
  return request({
 ...
 * @returns {Promise<any>}
 */
export function updateGoodsStockList(goods_id, params) {
  return request({
 ...
 * @returns {Promise<any>}
 */
export function getGoodData(ids) {
  return request({
 ...
 * @returns {Promise<any>}
 */
export function getTplList(ids) {
  return request({
 ...
 * @returns {Promise<any>}
 */
export function getSellingGoodsList(params) {
  return request({
    url: 'seller/goods/supplier/goods-list-buy',
    method: 'get',
    loading: false,
    params
  })
 ...
 * @returns {Promise<any>}
 */
export function getAboveGoodsList(params) {
  return request({
    url: 'seller/goods/supplier/goods-list-up',
    method: 'get',
    loading: false,
    params
  })
 ...
 * @returns {Promise<any>}
 */
export function getSkuGoodsList(goods_id) {
  return request({
    url: `seller/goods/supplier/sku/up/${goods_id}`,
    method: 'get',
    loading: false
  })
}
 ...
 * @returns {Promise<any>}
 */
export function aboveSupplyGoods(goods_id, params, category_id) {
  return request({
    url: `seller/goods/supplier/${goods_id}/seller/up/`,
    method: 'put',
    headers: { 'Content-Type': 'application/json' },
    data: params,
    params: {
 ...
 * @returns {Promise<any>}
 */
export function getDistributionGoodsList(params) {
  return request({
    url: 'seller/distribution/goods/list',
    method: 'get',
    loading: false,
    params
  })
 ...
 * @returns {Promise<any>}
 */
export function settingGoodsRebate(params) {
  return request({
    url: 'seller/distribution/goods/set-rebate',
    method: 'put',
    params
  })
}
...
export function terminationImportsTask(params) {
  return request({
    url: `/seller/goods/imports/task/force-stop`,
    method: 'get',
    params,
    loading: false
  })
...
export function goodsImportsStatus(params) {
  return request({
    url: `/seller/goods/imports/status`,
    method: 'get',
    params,
    loading: false
  })
 ...
 * @returns
 */
export function goodsGoodsProgramCode(goods_id) {
  return request({
    url: `/seller/goods/code-unlimit?goods_id=${goods_id}`,
    method: 'get',
    // params,
    loading: false
  })
 ...
 * @returns
 */
export function goodsBatchUnder(goods_ids, params = { reason: '' }) {
  return request({
    url: `/seller/goods/${goods_ids}/under`,
    method: 'put',
    params
  })
}
