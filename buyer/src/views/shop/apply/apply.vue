<template>
  <div id="apply-shop">
    <apply-header/>
    <router-view v-if="$route.name === 'shop-apply' || $route.name === 'shop-apply-success'"/>
...
#apply-shop ::v-deep .item-container {
  padding: 20px;
  .title {
    text-align: left;
    font-size: 22px;
