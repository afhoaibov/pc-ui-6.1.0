  ...
  export default {
    ...
    methods: {
      ...
      handleExamine(index, row) {
        this.$router.push({ path: `/shop/shop-manage/edit/${row.shop_id}?audit=1`, params: { callback: this.GET_ShopList }})
      },
      /** 开启店铺 */
      ...
      advancedSearchEvent() {
        ...
        if (shop_time_range) {
          this.params.start_time = shop_time_range[0] / 1000
          this.params.end_time = shop_time_range[1] / 1000
        }
