export default {
  ...
  methods: {
    ...
    getFriends() {
      this.request({
        url: this.apis['admin'] + `/admin/im/friends-list`,
        method: 'get',
        loading: false,
        needToken: true
      }).then(res => {
    ...
    getOrders() {
      ...
      let url = `${this.apis['admin']}/admin/im/orders/${this.receiver_id}`
      this.request({
        url,
        method: 'get',
        loading: false,
    ...
    createSession() {
      return this.request({
        url: this.apis['admin'] + `/admin/im/session/${this.receiver_id}`,
        method: 'post',
        loading: false,
        needToken: true
      }).then(res => {
    ...
    getGoodsList() {
      ...
      delete params.no_data
      delete params.loading
      let url = `${this.apis['admin']}/admin/im/visit-history/${this.receiver_id}`
      this.request({
        url,
        method: 'get',
        loading: false,
    ...
    getChatHistory() {
      ...
      delete params.loading
      this.request({
        url: this.apis['admin'] + `/admin/im/history`,
        method: 'get',
        loading: false,
        needToken: true,
        params
    ...
    async sendMessage(content, type) {
      ...
      const res = await this.request({
        url: this.apis['admin'] + `/admin/im/message/${type}`,
        method: 'post',
        loading: false,
        needToken: true,
        data
    ...
    removeUnreadNum() {
      return this.request({
        url: this.apis['admin'] + `/admin/im/unread-num`,
        method: 'delete',
        loading: false,
        needToken: true,
        params: {
    ...
    deleteFriend(id) {
      return new Promise((resolve, reject) => {
        let url = this.apis['admin'] + '/admin/im/delete'
