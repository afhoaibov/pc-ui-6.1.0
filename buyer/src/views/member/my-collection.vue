  ...
  <div id="my-collection">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li>
          <router-link to="/member/my-collection">商品收藏</router-link>
        </li>
        <li>
          <router-link to="/member/my-collection?type=shop">店铺收藏</router-link>
        </li>
      </ul>
    </div>
            ...
            >
              <div class="goods-image">
                ...
                <div class="goods-image-btns">
                  <router-link :to="'/shop/' + goods.shop_id" target="_blank">进入店铺</router-link>
                  <router-link :to="'/goods/' + goods.goods_id" target="_blank">查看商品</router-link>
                </div>
              </div>
              ...
              <div class="goods-price">
                <div class="price">
                  <strong>
                    <en-price :price="goods.goods_price" :sizeRatio="0.9" size="14" direction="row" />
                  </strong>
                </div>
                <div v-if="goods.goods_original_price" class="original-price">
                  <span>
                    <en-price :price="goods.goods_original_price" :sizeRatio="0.9" size="14" lineThrough direction="row" />
                  </span>
                </div>
              </div>
              <div class="del-pop">
                ...
                <swiper :options="shopSwiperOptions" class="shop-goods-list">
                  <swiper-slide v-for="goods in shop.goods_list" :key="goods.goods_id" class="goods-item">
                    ...
                    <div class="goods-price">
                      <div class="price">
                        <strong>
                          <en-price :price="goods.price" :sizeRatio="0.9" size="14" direction="row" />
                        </strong>
                      </div>
                      <div v-if="goods.original_price" class="original-price">
                        <span>
                          <en-price :price="goods.original_price" :sizeRatio="0.9" size="14" lineThrough direction="row" />
                        </span>
                      </div>
                    </div>
                  </swiper-slide>
