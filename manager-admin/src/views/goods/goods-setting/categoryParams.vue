  ...
  export default {
    ...
    watch: {
      ...
      $route: {
        immediate: true,
        handler(newVal) {
          if (newVal.name !== 'categoryParams') return
          this.category_id = newVal.params.id
          this.GET_CategoryParamsGroup()
        }
      }
    },
...
<style type="text/scss" lang="scss" scoped>
  ...
  .params-container ::v-deep .el-checkbox+.el-checkbox { margin-left: 20px }
  .params-container ::v-deep .el-button+.el-button { margin-left: 0 }
  .param-item {
    display: flex;
    align-items: center;
