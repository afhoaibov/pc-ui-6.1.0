      ...
      <el-row class="record-item" v-for="item in recordList.data" :key="item.task_id">
        <div class="item-left">
          ...
          <el-button
            ...
            ><a :href="item.task_result" :download="item.task_name">下载</a></el-button>
...
<script>
  ...
  // 导出类型常量
  const ModuleType = [
    { name: '订单导出', value: 'ShopOrderExport' },
    { name: '结算单导出', value: 'ShopBillExport' },
    { name: '售后服务单导出', value: 'ShopAfterSaleExport' },
    { name: '商品导出', value: 'ShopGoodsExport' }
  ]
  export default {
    name: 'deriveRecord',
    data() {
