...
export function getGoodsList(params) {
  return request({
    url: 'seller/goods/supplier/goods-list-page',
    method: 'get',
    loading: false,
    params
  })
...
export function updateGoodsStockList(goods_id, params) {
  return request({
    url: `seller/goods/supplier/${goods_id}/skus`,
    method: 'put',
    data: params,
 ...
 * @returns {Promise<any>}
 */
export function underGoods(goods_id, params) {
  return request({
    url: `seller/goods/supplier/${goods_id}/under`,
    method: 'put',
    data: params
  })
}
...
export function getSalesInfo(params) {
  return request({
    url: 'seller/goods/supplier/seller-goods',
    method: 'get',
    loading: false,
    params
  })
 ...
 * @returns {Promise<any>}
 */
export function getSalesInfoDetail(goods_id) {
  return request({
    url: 'seller/goods/supplier/seller-good-info',
    method: 'get',
    loading: false,
    params: {
      goods_id
