<template>
  <div id="shop-card" class="shop-card">
    <router-link :to="'/shop/' + shopId" class="shop-title">{{ shopBaseInfo.shop_name }}</router-link>
    <div class="shop-logo">
      <img :src="shopBaseInfo.shop_logo" :alt="shopBaseInfo.shop_name" style="width:100%;height:auto;">
    </div>
    <div class="shop-rate">
      <div class="rate-item">
        <h5>描述</h5>
    ...
    <div class="shop-btns">
      <router-link :to="'/shop/' + shopId" class="shop-btn into">进入商家店铺</router-link>
      <a href="javascript:;"
        @click="collectionShop"
        class="shop-btn collection"
      >
    ...
    <div class="shop-address">
      ...
      <dl>
        <dt>在线咨询：</dt>
        <dd>
          <a href='javascript:;' @click="MixinOpenIm(shopBaseInfo, { goods_id: goodsId })">在线客服<i class="iconfont ea-icon-service"></i></a>
        </dd>
      </dl>
    </div>
    <div class="shop-contact">
      <i class="iconfont ea-icon-call-phone"></i>
      <span v-if="shopBaseInfo.link_phone">{{ shopBaseInfo.link_phone|secrecyMobile}}</span>
