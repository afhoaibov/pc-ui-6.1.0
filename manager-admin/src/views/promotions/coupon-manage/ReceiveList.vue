    ...
    <div>
      ...
      >
        ...
        <template slot="table-columns">
          ...
          <el-table-column prop="coupon_price" label="优惠券面额"/>
    ...
    export default {
      ...
      data() {
        return {
          ...
          cancelFormRule: {
            cancel_reason: { required: true, message: '请输入作废原因', trigger: 'blur' }
          }
        }
      },
      watch: {
        ...
        handleCancelCoupon() {
          this.$refs.cancelForm.validate((valid) => {
            if (valid) {
              ...
              API_Promotion.nullifyCoupons(mc_id, params).then(response => {
