    ...
    <div class="member-nav">
      <ul class="member-nav-list">
        <li :class="[type === 1 && 'active']">
          <router-link to="/member/my-points">积分</router-link>
        </li>
        <li :class="[type === 2 && 'active']">
          <router-link to="/member/my-points?type=detail">积分明细</router-link>
        </li>
      </ul>
    </div>
...
.points-my ::v-deep .el-alert--warning {
  h2 {
    font-size: 18px;
    margin-bottom: 10px;
  }
...
.points-my ::v-deep .el-alert--info {
  margin-top: 15px;
  h2 {
    font-size: 16px;
    margin-bottom: 10px;
