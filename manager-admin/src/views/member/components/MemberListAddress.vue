<template>
  <div>
    <el-table :data="tableData.data" :header-cell-style="{textAlign: 'center'}">
      ...
      <el-table-column :formatter="formatterAddress" label="所在地区" align="center"/>
      <el-table-column prop="addr" label="详细地址" align="center"/>
      <el-table-column prop="mobile" label="手机号码" align="center">
        <template slot-scope="scope">{{ scope.row.mobile | formatMobile }}</template>
      </el-table-column>
