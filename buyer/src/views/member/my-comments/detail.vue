    ...
    <div class="comments-goods-box">
      <div class="comments-item">
        <a class="comments-goods">
          <div class="show-goods-image">
            <router-link :to="'/goods/' + commentsDetail.goods_id" target="_blank">
              <img :src="commentsDetail.goods_img">
            </router-link>
          </div>
          <div class="goods-name">
            <router-link :to="'/goods/' + commentsDetail.goods_id" target="_blank" v-html="commentsDetail.goods_name">
        ...
        <div class="comments-content">
          <div class="shop-grade" v-if="commentsDetail.member_shop_score">
            <h3>店铺评分</h3>
            <ul>
              <li class="shop-grade-item">描述相符：
                <el-rate v-model="commentsDetail.member_shop_score.description_score" score-template="{value}分" text-color="#666" show-score disabled></el-rate>
              </li>
              <li class="shop-grade-item">服务态度：
                <el-rate v-model="commentsDetail.member_shop_score.service_score" score-template="{value}分" text-color="#666" show-score disabled></el-rate>
              </li>
              <li class="shop-grade-item">物流服务：
                <el-rate v-model="commentsDetail.member_shop_score.delivery_score" score-template="{value}分" text-color="#666" show-score disabled></el-rate>
              </li>
            </ul>
          </div>
