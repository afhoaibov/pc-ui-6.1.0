...
export function getTagGoods(seller_id, mark = 'hot', num = 5) {
  return request({
    url: `/buyer/goods/tags/${mark}/goods`,
    method: Method.GET,
    loading: false,
    params: {
      seller_id,
...
export function getCategory(parent_id = 0) {
  return request({
    url: `/buyer/goods/categories/${parent_id}/children`,
    method: Method.GET,
    loading: false
  })
}
...
export function getFirstCategory() {
  return request({
    url: `/buyer/goods/categories/first-category`,
    method: Method.GET,
    loading: false
  })
}
...
export function getGoodsShip(goods_id, area_id) {
  return request({
    url: `/buyer/goods/${goods_id}/area/${area_id}`,
    method: Method.GET
  })
}
 ...
 * @param sku_id
 */
export function getGoodsSkusShop(sku_id) {
  return request({
    url: `/buyer/goods/sku/${sku_id}/goods-id`,
    method: Method.GET,
    loading: false
  })
}
