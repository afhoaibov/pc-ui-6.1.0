...
export function getLiveVideoList(params) {
  return request({
    url: `${api.zhibo}/seller/live-video/rooms`,
    method: 'get',
    loading: false,
    params
  })
...
export function auditLiveVideoRooms(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/rooms/${id}/audit`,
    method: 'post',
    loading: false
  })
}
...
export function getLiveVideo(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/rooms/${id}`,
    method: 'get',
    loading: false
  })
}
...
export function bindLiveVideoGoods(room_id, good_ids) {
  return request({
    url: `${api.zhibo}/seller/live-video/rooms/${room_id}`,
    method: 'post',
    params: {
      good_ids
    }
...
export function getLiveVideoGoods(room_id, params) {
  return request({
    url: `${api.zhibo}/seller/live-video/rooms/${room_id}/get-goods-list`,
    method: 'get',
    loading: false,
    params
  })
...
export function getLiveVideoMedia(media_id) {
  return request({
    url: `${api.base}/base/seller/live-video/media/download`,
    method: 'get',
    responseType: 'blob',
    loading: false,
    params: {
...
export function getLiveVideoGoodsList(params) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods`,
    method: 'get',
    loading: false,
    params
  })
...
export function getLiveGoods(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods/${id}`,
    method: 'get',
    loading: false
  })
}
...
export function againAuditLiveVideoGoods(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods/${id}/again-audit`,
    method: 'post',
    loading: false
  })
}
...
export function submitAuditLiveVideoGoods(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods/${id}/audit`,
    method: 'post',
    loading: false
  })
}
...
export function resetAuditLiveVideoGoods(id) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods/${id}/reset-audit`,
    method: 'post',
    loading: false
  })
}
...
export function getLiveVideoSku(params) {
  return request({
    url: `${api.zhibo}/seller/live-video/goods/sku`,
    method: 'get',
    loading: false,
    params
  })
