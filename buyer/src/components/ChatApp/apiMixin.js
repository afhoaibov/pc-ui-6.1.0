export default {
  ...
  methods: {
    ...
    getFriends() {
      this.request({
        url: this.apis['buyer'] + `/${this.type}/im/friends-list`,
        method: 'get',
        loading: false,
        needToken: true
      }).then(res => {
    ...
    getOrders() {
      ...
      let url = this.isSeller
        ...
        : `${this.apis['buyer']}/${this.type}/im/orders/${this.receiver_id}`
      this.request({
        url,
        method: 'get',
        loading: false,
    ...
    createSession() {
      return this.request({
        url: this.apis['buyer'] + `/${this.type}/im/session/${this.receiver_id}`,
        method: 'post',
        loading: false,
        needToken: true
      }).then(res => {
    ...
    getGoodsList() {
      ...
      let url = this.isSeller
        ...
        : `${this.apis['buyer']}/buyer/members/history/list-page`
      this.request({
        url,
        method: 'get',
        loading: false,
    ...
    getGoodsDetail() {
      ...
      this.request({
        url: this.apis['buyer'] + `/${this.type}/goods/${this.goods_id}`,
        loading: false
      }).then(res => {
        this.askGoods = res
      })
    ...
    getChatHistory() {
      ...
      delete params.loading
      this.request({
        url: this.apis['buyer'] + `/${this.type}/im/history`,
        method: 'get',
        loading: false,
        needToken: true,
        params
    ...
    async sendMessage(content, type) {
      ...
      const res = await this.request({
        url: this.apis['buyer'] + `/${this.type}/im/message/${type}`,
        method: 'post',
        loading: false,
        needToken: true,
        data
    ...
    removeUnreadNum() {
      return this.request({
        url: this.apis['buyer'] + `/${this.type}/im/unread-num`,
        method: 'delete',
        loading: false,
        needToken: true,
        params: {
    ...
    uploadFile(file) {
      return new Promise(resolve => {
        ...
        this.request({
          url: this.apis['buyer'] + `/${this.type}/uploaders`,
          method: 'post',
          headers: {
