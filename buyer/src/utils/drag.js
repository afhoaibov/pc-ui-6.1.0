...
const drag = Vue.directive('drag', {
  ...
  inserted: function(el, binding, vnode) {
    el.onmousedown = function(e) {
      const distX = e.pageX - el.offsetLeft
      const distY = e.pageY - el.offsetTop
      ...
      document.onmousemove = function(e) {
        ...
        if (top <= 0) {
          top = 5
        } else if (top > document.documentElement.offsetHeight - el.clientHeight) {
          top = document.documentElement.offsetHeight - el.clientHeight - 5
        }
