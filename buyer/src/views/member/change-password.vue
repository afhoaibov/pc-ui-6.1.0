  ...
  <div id="change-password">
    ...
    <div v-show="step === 2" class="change-password-container">
      ...
      <el-form :model="changePasswordForm" :rules="changePasswordRules" ref="changePasswordForm" label-width="140px">
        ...
        <el-form-item label="图片验证码：" prop="captcha" class="img-code" v-if="validateInFO.validator_type === 'IMAGE'">
...
export default {
  ...
  methods: {
    ...
    changePassword() {
      ...
      const { tencentParams, validateInFO } = this
      params.uuid = this.uuid
      params.randstr = tencentParams.randstr
      params.ticket = tencentParams.ticket
      if (validateInFO.validator_type !== 'IMAGE') {
