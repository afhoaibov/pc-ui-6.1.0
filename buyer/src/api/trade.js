...
export function getCarts(show_type = 'all', way = 'CART') {
  return request({
    url: `/buyer/trade/carts/${show_type}?way=` + way,
    method: Method.GET,
    needToken: true,
    loading: false
  })
...
export function updateSkuNum(sku_id, num = 1) {
  return request({
    url: `/buyer/trade/carts/sku/${sku_id}`,
    method: Method.POST,
    needToken: true,
    data: { num }
  })
...
export function deleteSkuItem(sku_ids) {
  return request({
    url: `/buyer/trade/carts/${sku_ids}/sku`,
...
export function checkShop(shop_id, checked) {
  return request({
    url: `/buyer/trade/carts/seller/${shop_id}`,
    method: Method.POST,
    needToken: true,
    params: { checked }
  })
...
export function getCheckoutParams() {
  return request({
    url: '/buyer/trade/checkout-params',
    method: Method.GET,
    needToken: true
  })
}
...
export function setAddressId(address_id) {
  return request({
    url: `/buyer/trade/checkout-params/address-id/${address_id}`,
    method: Method.POST,
    needToken: true
  })
}
...
export function setPaymentType(payment_type = 'ONLINE') {
  return request({
    url: '/buyer/trade/checkout-params/payment-type',
    method: Method.POST,
    needToken: true,
    data: { payment_type }
  })
...
export function setRecepit(params) {
  return request({
    url: '/buyer/trade/checkout-params/receipt',
    method: Method.POST,
    needToken: true,
    params
  })
...
export function setReceiveTime(receive_time) {
  return request({
    url: '/buyer/trade/checkout-params/receive-time',
    method: Method.POST,
    needToken: true,
    data: { receive_time }
  })
...
export function setRemark(remark) {
  return request({
    url: '/buyer/trade/checkout-params/remark',
    method: Method.POST,
    needToken: true,
    data: { remark }
  })
...
export function getCashierData(params) {
  return request({
    url: '/buyer/trade/orders/cashier',
    method: Method.GET,
    needToken: true,
    params
  })
...
export function getPayStatus(trade_type, sn, params) {
  return request({
    url: `/buyer/order/pay/query/${trade_type}/${sn}`,
    method: Method.GET,
    needToken: true,
    params
  })
...
export function getWeChatQrStatus(sn) {
  return request({
    url: `/buyer/payment/weixin/status/${sn}`,
    method: Method.GET,
    needToken: true,
    loading: false
  })
...
export function initiatePay(trade_type, sn, params) {
  return request({
    url: `/buyer/order/pay/${trade_type}/${sn}`,
    method: Method.GET,
    needToken: true,
    params
  })
 ...
 * @param coupon_id
 */
export function useCoupon(mc_id, params) {
  return request({
    url: `/buyer/trade/carts/coupon/use/${mc_id}`,
    method: Method.POST,
    needToken: true,
    params
  })
...
export function getOrderFlow(order_sn) {
  return request({
    url: `/buyer/trade/orders/${order_sn}/flow`,
    method: Method.GET,
    needToken: true
  })
}
 ...
 * @param id
 */
export function getSellerSnapshot(id) {
  return request({
    url: `${process.env.API_SELLER || api.seller}/seller/trade/snapshots/${id}`,
    method: Method.GET,
    needToken: true
  })
}
...
export function getGoodsSales(goods_id, params) {
  return request({
    url: `/buyer/trade/goods/${goods_id}/sales`,
    method: Method.GET,
    loading: false,
    params
  })
...
/* 取消订单时间 */
export function cancelLeftTime(trade_sn, params) {
  return request({
    url: `/buyer/trade/orders/${trade_sn}/cancel-left-time`,
    method: Method.GET,
    needToken: true,
    params
  })
