<template>
  <div>
    <template v-if="finishedComments && finishedComments.data.length">
          ...
          <li v-for="item in finishedComments.data" :key="item.comment_id">
            <div class="order-tbody-item">
              ...
              <div class="order-item-price">
                <span>{{ item.audit_status | auditStatus }}</span>
              </div>
              <div class="order-item-operate">
                <router-link :to="`/member/my-comments/detail?comment_id=${item.comment_id}`">查看评价</router-link>
              </div>
            </div>
          </li>
        </ul>
