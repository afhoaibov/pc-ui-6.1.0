...
export function collectionShop(shop_id) {
  return request({
    url: '/buyer/members/collection/shop',
    method: Method.POST,
    needToken: true,
    data: { shop_id }
  })
...
export function logout() {
  if (Storage.getItem('uid')) {
    return request({
      url: `/buyer/members/logout?uid=${Storage.getItem('uid')}`,
      method: Method.POST,
      needToken: true
    })
  } else {
...
export function addReceipt(params) {
  return request({
    url: `/buyer/members/receipt?${qs.stringify(params)}`,
    method: Method.POST,
    needToken: true
  })
}
...
export function editReceipt(id, params) {
  return request({
    url: `/buyer/members/receipt/${id}?${qs.stringify(params)}`,
    method: Method.PUT,
    needToken: true
  })
}
...
export function getAccountBinder() {
  return request({
    url: '/buyer/members/account-binder',
    method: Method.GET,
    needToken: true
  })
}
...
export function bindAccount(type) {
  return request({
    url: `/buyer/members/account-binder/pc/${type}`,
    method: Method.GET,
    needToken: true
  })
}
...
export function loginBindAccount(uuid) {
  return request({
    url: `/buyer/members/account-binder/login/${uuid}`,
    method: Method.POST,
    needToken: true
  })
}
...
export function registerBindAccount(uuid) {
  return request({
    url: `/buyer/members/account-binder/register/${uuid}`,
    method: Method.POST,
    needToken: true
  })
}
...
export function deleteHistoryDetailDate(day) {
  return request({
    url: `/buyer/members/history/day/${day}`,
    method: Method.DELETE,
    needToken: true
  })
}
 ...
 * @param goods_id
 */
export function getGoodsRelationAsk(ask_id, goods_id) {
  return request({
    url: `/buyer/members/asks/relation/${ask_id}/${goods_id}`,
    method: Method.GET,
    loading: false
  })
}
