      ...
      <el-form :model="smtpForm" :rules="smtpRules" ref="smtpForm" size="small" label-width="120px">
        <template>
          <el-form-item label="HOST" prop="host">
            <el-input v-model="smtpForm.host" clearable/>
          </el-form-item>
          <el-form-item label="PORT" prop="port">
            <el-input v-model="smtpForm.port" clearable/>
          </el-form-item>
        </template>
<!--        <el-form-item label="sendGrid秘钥" prop="sendgrid_api_key" v-if="open_i18n">-->
<!--          <el-input v-model="smtpForm.sendgrid_api_key" clearable/>-->
<!--        </el-form-item>-->
        <template>
          ...
          <el-form-item label="用户名" prop="username">
            <el-input v-model="smtpForm.username" clearable/>
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <el-input type="password" autocompete="off" v-model="smtpForm.password" clearable/>
          </el-form-item>
          <el-form-item label="每日最大发信数" prop="max_count">
            <el-input v-model="smtpForm.max_count" clearable/>
          </el-form-item>
        </template>
        <el-form-item label="发信邮箱" prop="mail_from">
          <el-input v-model="smtpForm.mail_from" clearable/>
        </el-form-item>
        <el-form-item label="测试" :error="test_email_error">
          <el-input v-model="test_email" clearable>
    ...
    data() {
      return {
        ...
        smtpRules: {
          ...
          // sendgrid_api_key: [this.MixinRequired('请输入sendGrid秘钥！')],
          port: [
