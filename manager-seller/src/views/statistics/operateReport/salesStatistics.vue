<template>
  <div class="bg-shop-summary">
    ...
    <br>
    <br>
    <el-tabs v-model="salesType" type="border-card" @tab-click="changeHotType">
      <el-tab-pane label="下单量" name="num">
        <div v-if="salesType === 'num'" id="orderNum" :style="[{height:tableHeight + 'px'}]"></div>
      </el-tab-pane>
      <el-tab-pane label="下单金额" name="price">
        <div v-if="salesType === 'price'" id="orderAmount" :style="[{height:tableHeight + 'px'}]"></div>
      </el-tab-pane>
    </el-tabs>
    <en-table-layout
      pagination
  ...
  export default {
    ...
    methods: {
      ...
      changeYearMonth(obj) {
        ...
        this.salesType === 'num' ? this.GET_OrderTotaltChart() : this.GET_OrderGoodsNumData()
      ...
      GET_OrderTotaltChart() {
        this.loading = true
        API_salesStatistics.getSalesStatisticsNum(this.params).then(async response => {
          this.loading = false
          await this.$nextTick()
          this.orderGoodsNumChart = echarts.init(document.getElementById('orderNum'))
      ...
      GET_OrderGoodsNumData() {
        this.loading = true
        API_salesStatistics.getSalesStatisticsMoney(this.params).then(async response => {
          this.loading = false
          await this.$nextTick()
...
<style type="text/scss" lang="scss" scoped>
  ...
  .bg-shop-summary ::v-deep .el-table td:not(.is-left) {
    text-align: center;
  }
