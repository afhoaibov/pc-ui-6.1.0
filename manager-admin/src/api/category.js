...
export function getBrandByCategoryId(category_id) {
  return request({
    url: `/admin/goods/categories/${category_id}/brands/selected`,
    method: 'get',
    loading: false
  })
}
...
/**
 * 品牌搜索
 * 搜素某个分类下的品牌，包含了已关联的和未关联的。
 */
export function BrandSearch(categroy_id, params) {
  return request({
    url: `/admin/goods/categories/${categroy_id}/brands`,
    method: 'get',
    params
  })
}
 ...
 */
export function editCategoryBrand(category_id, data) {
  return request({
