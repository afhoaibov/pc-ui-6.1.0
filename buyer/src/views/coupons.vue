      ...
      >
        ...
        <div class="info-coupon">
          <div class="price-coupon">
            <en-price :price="coupon.coupon_price" size="30"/>
          </div>
        ...
        <div class="opt-coupon" @click="receiveCoupon(coupon)">
          <div class="btn-opt-coupon">
            <a v-if="coupon.create_num === coupon.received_num"><b></b><span class="text">已领完</span></a>
            <a v-else href="javascript:;"><b></b>
              <span v-if="!open_i18n" class="text">立即领取</span>
              <p v-else class="in18-box">
                <span class="in18-text">立即</span>
                <span class="in18-text">领取</span>
              </p>
            </a>
          </div>
        </div>
