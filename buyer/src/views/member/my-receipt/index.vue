  ...
  <div id="my-receipt">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <router-link to="/member/my-receipt" style="color:#f42424;">我的发票</router-link>
        </li>
      </ul>
    </div>
    <template v-if="receiptData && receiptData.data.length">
            ...
            <li v-for="receipt in receiptData.data" :key="receipt.order_sn">
              ...
              <div class="receipt-tbody-item">
                ...
                <div class="receipt-item-status">
                  <span v-if="receipt.status === 0">未开票</span>
                  <span v-if="receipt.status === 1">已开票</span>
                </div>
                <div class="receipt-item-operation">
                  <router-link :to="'/member/my-receipt/detail?history_id=' + receipt.history_id">发票详情</router-link>
                </div>
              </div>
            </li>
          </template>
    ...
    <empty-member v-else>暂无发票信息</empty-member>
  </div>
</template>
