  ...
  <div id="my-collection">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li>
          <router-link to="/member/goods-collection" style="color:#f42424;">收藏的商品</router-link>
        </li>
      </ul>
    </div>
          ...
          <ul>
            ...
            >
              ...
              <div class="goods-price">
                <div class="price">
                  <strong>
                    <en-price :price="goods.goods_price" direction="row" />
                  </strong>
                  <strong v-if="goods.exchange_point && goods.exchange_point !== 0"> + {{ goods.exchange_point }}积分</strong>
                </div>
              </div>
              <div class="del-pop">
