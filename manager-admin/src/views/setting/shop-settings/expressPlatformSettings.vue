<template>
  <div class="express-platform-settings">
    <en-table-layout
      :toolbar="false"
  ...
  export default {
    ...
    methods: {
      ...
      handleEditExpressPlatform(index, row) {
        const expressForm = this.MixinClone(row)
        expressForm.config_items.map(item => {
          if (item.type === 'radio') {
...
<style type="text/scss" lang="scss" scoped>
  .express-platform-settings ::v-deep .el-form-item__content{
    width: 60%;
  }
</style>
