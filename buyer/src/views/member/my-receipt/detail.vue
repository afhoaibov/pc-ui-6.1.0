  ...
  <div id="receipt-detail">
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <router-link to="/member/my-receipt">我的发票</router-link>
        </li>
      </ul>
    </div>
        ...
        <div class="receipt-content">
          <ul>
            <li>
              ...
              {{ receiptDetail.receipt_type | $$receipt }}
            </li>
            <li>
              <div class="title">发票内容</div>
              <span>{{ receiptDetail.receipt_content }}</span></li>
            <li>
              <div class="title">发票抬头</div>
              <span>{{ receiptDetail.receipt_title }}</span></li>
            ...
            <li>
              <div class="title">收票人手机号</div>
              <span>
                <clipboard :text="receiptDetail.member_mobile | formatMobile" />
              </span>
            </li>
            <li v-if="receiptDetail.member_email">
              <div class="title">收票人邮箱</div>
              <span>{{ receiptDetail.member_email }}</span></li>
            <li>
            ...
            <li v-if="receiptDetail.status === 1">
              ...
              <a :href="this.receiptDetail.elec_file_list[0]" target="_blank">点击下载</a>
            </li>
          </ul>
        </div>
      </template>
      ...
      <template v-if="receiptDetail.receipt_type === 'VATORDINARY'">
        <div class="receipt-content">
          <ul>
            <li>
              <div class="title">发票类型</div>
              <span>{{ receiptDetail.receipt_type | $$receipt }}</span></li>
            <li>
              <div class="title">发票内容</div>
              <span>{{ receiptDetail.receipt_content }}</span></li>
            <li>
            ...
            <li>
              <div class="title">收票人</div>
              <span>{{ receiptDetail.member_name }}</span></li>
            <li>
            ...
            <li>
              ...
              <span>
                {{ `${receiptDetail.province || ''}${receiptDetail.city || ''}${receiptDetail.county || ''}${receiptDetail.town || ''}${receiptDetail.detail_addr || ''}` }}
              </span>
            </li>
            <li v-if="receiptDetail.status === 1">
              <div class="title">物流公司</div>
              <span>{{ receiptDetail.logi_name }}</span></li>
            <li v-if="receiptDetail.status === 1">
        ...
        <div class="receipt-content">
          <ul>
            ...
            <li>
              ...
              <span>{{ receiptDetail.receipt_method }}</span></li>
            <li>
            ...
            <li>
              ...
              <span>{{ receiptDetail.reg_addr }}</span></li>
            <li>
            ...
            <li>
              ...
              <span>{{ receiptDetail.bank_name }}</span></li>
            <li>
      ...
      <el-dialog :visible.sync="logisticsShow" width="400px" align="center">
        <div slot="title">
          ...
          <div class="logistics-base">
            <span>
              物流公司：
              <clipboard :text="logisticsInfoList.name" />
            </span>
            <span>快递单号：
              <clipboard :text="logisticsInfoList.courier_num" />
            </span>
          </div>
        </div>
...
Vue.use(Dialog).use(Steps).use(Step)
...
// TODO
.receipt-detail ::v-deep .el-dialog__body {
  padding: 20px 25px;
  .logistics-info {
    max-height: 500px;
    overflow-y: scroll;
