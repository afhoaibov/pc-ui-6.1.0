...
export function getArticleCategory(category_type) {
  return request({
    url: `${api.base}/base/pages/article-categories`,
    method: Method.GET,
...
export function getArticleDetail(id) {
  return request({
    url: `${api.base}/base/pages/articles/${id}`,
    method: Method.GET
  })
}
...
export function getArticlesByPosition(position) {
  return request({
    url: `${api.base}/base/pages/${position}/articles`,
    method: Method.GET
  })
}
...
export function getArticlesByCategory(category_type) {
  return request({
    url: `${api.base}/base/pages/article-categories/${category_type}/articles`,
    method: Method.GET,
    loading: false
  })
}
