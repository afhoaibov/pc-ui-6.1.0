  ...
  <div>
    <div class="member-nav">
      <ul class="member-nav-list">
        <li class="active">
          <router-link to="/member/my-footprint" style="color:#f42424;">浏览记录</router-link>
        </li>
      </ul>
    </div>
    <div v-if="footPrints && footPrints.data.length" class="foot-print-container">
        ...
        >
          ...
          <div class="goods-print-out">
            <div class="goods-print" v-for="(goods, _index) in foot.history" :key="_index">
              ...
              <router-link target="_blank" :to="`/goods/${goods.goods_id}`">
              ...
              <span class="goods-price">
                <en-price :price="goods.goods_price" direction="row" :sizeRatio="0.9" size="14" />
              </span>
    ...
    <empty-member v-else>暂无足迹信息</empty-member>
  </div>
</template>
