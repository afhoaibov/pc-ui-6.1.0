...
(function ($, window, document, undefined) {
  ...
  addressSelect.prototype = {
    ...
    initEvent: function () {
      ...
      if (Array.isArray(_this.options.deData)) {
        _this.options.deData = _this.options.deData.map(item => {
          if (!item) return -1
    ...
    selectRegion: function () {
      ...
      node.appContent.on('click', '.app-address-area-a', function () {
        ...
        node.appBody.find('.app-address-tab-a').eq(_index).nextAll().find('em').html(window.__$t_please_select__ || '请选择');
    ...
    createElement: function () {
      var node = this.node;
      //  创建tab
      var tabA = '<a href="javascript: void(0);" class="app-address-tab-a show"> <em>'+ (window.__$t_please_select__ || '请选择') +'</em> <i style="padding: 0;"></i> </a>';
    ...
    initElement: function () {
      ...
      var html = '<div class="app-address">'
        ...
        + '<div class="app-address-title-view">-- '+ (window.__$t_please_select__ || '请选择') +' --</div><i style="padding: 0;"></i></div>'
        + '<div class="app-address-body">'
        + '<div class="app-address-tab">'
        + '<a href="javascript: void(0);" class="app-address-tab-a show"><em>'+ (window.__$t_please_select__ || '请选择') +'</em> <i class="cur" style="padding: 0;"></i></a></div>'
